...
## ✨ Features
* **Dashboard-Ready:** Generiert automatisch formatierte, saubere Listen (inkl. Emojis) deiner offenen Fenster für `input_text` Helfer. 
...
* **Sperrsignale (Blocker):** Stellt globale Signale (`input_boolean`) bereit, um z. B. das Scharfschalten einer Alarmanlage bei offenen Fenstern zu verhindern.
